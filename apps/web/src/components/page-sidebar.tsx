...
export function PageSidebar() {
  return (
    <Sidebar collapsible="none" className="hidden h-screen flex-1 md:flex bg-transparent min-w-[320px] max-w-[320px]">
          ...
          <SidebarGroupContent>
            {mails.map((mail) => (
              ...
              >
                ...
                <span className="line-climp-2 w-[260px] whitespace-break-spaces text-xs">{mail.teaser}</span>
              </a>
            ))}
          </SidebarGroupContent>
        </SidebarGroup>
